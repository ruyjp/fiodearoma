    ...
    subcategorias: [
      {
        ...
        banner: "images/guia-sabonetes-perfumados.jpg",
      },
      {
        id: "especiais",
        titulo: "Sabonetes Especiais",
        banner: "images/guia-sabonetes-especiais.jpg",
      },
      {
        id: "geleia",
...
const produtos = [
  ...
  },
  {
    ...
    cat: "corpoBanho",
    subcat: "especificos",
    nome: "Sabonete Carvão Ativado (80g)",
    desc: "",
    icon: "fa-bottle-droplet",
  ...
  },
  {
    ...
    cat: "corpoBanho",
    subcat: "colher",
    nome: "Sabonete de Colher Esfoliante (130g)",
    desc: "Esfoliante e hidratante feito com manteiga corporal",
    icon: "fa-bottle-droplet",
  ...
  },
  {
    ...
    variantes: [
      ...
      {
        idVar: "v3",
        nome: "Alecrim (Banho diário)",
        preco: 10.99,
        imagem: "images/sabonete-masculino-alecrim.jpg",
      },
      {
        idVar: "v4",
        nome: "Kit com os 3 sabonetes",
        preco: 34.99,
        imagem: "kit-3sabonetes.jpg",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    cat: "vela",
    subcat: "velaPerfumada",
    nome: "Vela Especial<br> Morango com Champanhe",
    desc: "",
    icon: "fa-house-chimney",
  ...
  },
  {
    ...
    cat: "presentes",
    subcat: "lembrancinha",
    nome: "Lembrancinha de Coração",
    desc: "",
    icon: "fa-house-chimney",
    imagemPrincipal: "images/lembrancinha-coracao.jpg",
    variantes: [
      {
        idVar: "v1",
        nome: "1 a 10 unidades",
        preco: 2.5,
        imagem: "images/lembrancinha-coracao.jpg",
      },
      {
        idVar: "v2",
        nome: "11 a 30 unidades",
  ...
  },
  {
    ...
    cat: "presentes",
    subcat: "kits",
    nome: "Kit com 3 Sabonetes Masculinos",
    desc: "",
    icon: "fa-house-chimney",
    imagemPrincipal: "images/kit-3sabonetes.jpg",
    variantes: [
      {
        idVar: "v1",
        nome: "",
        preco: 72.99,
        imagem: "images/kit-3sabonetes.jpg",
      },
    ],
  },
];
